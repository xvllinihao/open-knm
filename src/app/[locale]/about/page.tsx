          ...
          <div className="flex flex-col sm:flex-row gap-8 items-start sm:items-center mb-8 border-b border-white/10 pb-8">
             ...
             <div>
               ...
               <div className="flex gap-3 text-xs font-bold tracking-wide">
                  ...
                  <a href="https://xhslink.com/m/8J6IpXc7bHx" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#ff2442]/20 hover:bg-[#ff2442]/40 text-[#ff2442] hover:text-white ring-1 ring-[#ff2442]/50 transition-all">
                    小红书
                  </a>
               </div>
             </div>
